...
def app():
    ...
    st.write('I conducted a survey among ISAT University students and ask if they agree or disagree that 
    Studying grammar is better than practising conversational skill and briefly explain their answer.  \
